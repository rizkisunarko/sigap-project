                        ...
                        <?php foreach ($riwayatKunjungan as $index => $riwayat): ?>
                            ...
                            <div style="border: 1px solid #111; border-radius: 8px; padding: 15px 30px; margin-bottom: <?= ($index === $totalKunjungan - 1) ? '0' : '15px' ?>;" class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    ...
                                    <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#riwayatPasienModal-<?= $riwayat['id_rekam_medis'] ?>" style="font-size: 0.85rem; color: #111; font-weight: 700; text-decoration: none;">Lihat Detail Penanganan &rarr;</a>
                                </div>
                            </div>
